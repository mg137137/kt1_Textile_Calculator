...
void main() => runApp(OilMill_Calculator());

class OilMill_Calculator extends StatefulWidget {
  @override
  _OilMill_CalculatorState createState() => _OilMill_CalculatorState();
}

class _OilMill_CalculatorState extends State<OilMill_Calculator> {
            ...
            items: <BottomNavigationBarItem>[
              BottomNavigationBarItem(
                backgroundColor: _selectedIndex == 0
                    ? Colors.blue
                    : Colors.red, // Set the selected item box color here
                icon: Icon(Icons.arrow_forward_outlined),
                label: 'Oil Mill Forward',
              ),
              BottomNavigationBarItem(
...
class Forward_Calculator extends StatefulWidget {
  @override
  _MyWidgetState createState() => _MyWidgetState();
}

class _MyWidgetState extends State<Forward_Calculator> {
  // for calculator 1
  ...
  void initState() {
    ...
    inputoilrate1.addListener(_updateValues_for_calculator1);
    ...
    inputoilrate2.addListener(_updateValues_for_calculator2);
  ...
  void _updateValues_for_calculator1() {
    ...
    double store_input_oilrate1 = double.tryParse(inputoilrate1.text) ?? 0;
    ...
    double a2 = sum1 * 5;
    double a3 = (store_input_oilrate1 / 10) * store_input_kapasia1;
    double a4 = a2 - a3;
    double f = (a4 / store_input_utaro1) * store_input_ghati1;
    diff1 = f;
  ...
  void _updateValues_for_calculator2() {
    ...
    double store_input_oilrate2 = double.tryParse(inputoilrate1.text) ?? 0;
    ...
    double a2 = sum1 * 5;
    double a3 = (store_input_oilrate2 / 10) * store_input_kapasia2;
    double a4 = a2 - a3;
    double f = (a4 / store_input_utaro2) * store_input_ghati2;
    diff2 = f;
    int sum2 = f.round().toInt();
...
class Reverse_Calculator extends StatefulWidget {
  @override
  State<Reverse_Calculator> createState() => _Reverse_CalculatorState();
}

class _Reverse_CalculatorState extends State<Reverse_Calculator> {
  // for calculator 1
  final inputkapas1 = TextEditingController();
  final inputexpense1 = TextEditingController();
  final inputoilrate1 = TextEditingController();
  ...
  void _updateValues_for_calculator1() {
    ...
    double store_input_utaro1 = double.tryParse(inpututaro1.text) ?? 0;
    double store_input_ghati1 = double.tryParse(inputghati1.text) ?? 0;
    int sum1 = (store_input_kapas1 / store_input_ghati1).round().toInt();
    result_addition_inputkapas1_and_inputexpense1.add(sum1);
    double a2 = (store_input_kapas1 / store_input_ghati1) * store_input_utaro1;
    double a3 = (store_input_oilrate1 / 10) * store_input_kapasia1;
    double a4 = a2 + a3;
    double a5 = a4 / 5;
    double f = (a5 - store_input_expense1);
    diff1 = f;
    int sum2 = f.round().toInt();
    result_final_output_padtar1.add(sum2);
  ...
  void _updateValues_for_calculator2() {
    ...
    double store_input_utaro2 = double.tryParse(inpututaro2.text) ?? 0;
    double store_input_ghati2 = double.tryParse(inputghati2.text) ?? 0;
    int sum1 = (store_input_kapas2 / store_input_ghati2).round().toInt();
    result_addition_inputkapas1_and_inputexpense1.add(sum1);
    double a2 = (store_input_kapas2 / store_input_ghati2) * store_input_utaro2;
    double a3 = (store_input_oilrate2 / 10) * store_input_kapasia2;
    double a4 = a2 + a3;
    double a5 = a4 / 5;
    double f = (a5 - store_input_expense2);
    diff2 = f;
    int sum2 = f.round().toInt();
    result_final_output_padtar2.add(sum2);
