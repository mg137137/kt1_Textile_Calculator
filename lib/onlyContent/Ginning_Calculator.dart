...
void main() => runApp(Ginning_Calculator());

class Ginning_Calculator extends StatefulWidget {
  @override
  _Ginning_CalculatorState createState() => _Ginning_CalculatorState();
}

class _Ginning_CalculatorState extends State<Ginning_Calculator> {
