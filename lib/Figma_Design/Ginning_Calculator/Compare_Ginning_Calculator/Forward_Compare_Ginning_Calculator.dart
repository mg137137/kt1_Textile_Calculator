...
class Forward_Compare_Ginning_Calculator extends StatefulWidget {
  const Forward_Compare_Ginning_Calculator({Key? key}) : super(key: key);

  @override
  State<Forward_Compare_Ginning_Calculator> createState() =>
      _Forward_Compare_Ginning_CalculatorState();
}

class _Forward_Compare_Ginning_CalculatorState
    extends State<Forward_Compare_Ginning_Calculator> {
  // for calculator 1
              ...
              Column(
                children: [
                  ...
                  buildRowComapreWidget(
                      'Kapas', inputkapas1, '₹/20kg', FixedHeight, FixedWidth),
                  ...
                  child: StreamBuilder<int>(
                    ...
                    builder:
                      ...
                      if (snapshot6.hasData) {
                        return GradientText(
                          'Khandi Difference :- ' + '${snapshot6.data}' + ' ₹',
                          textAlign: TextAlign.center,
                          style: TextStyle(
