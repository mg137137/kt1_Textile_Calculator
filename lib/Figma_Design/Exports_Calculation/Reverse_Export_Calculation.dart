...
class Reverse_Export_Calculation extends StatefulWidget {
  const Reverse_Export_Calculation({Key? key}) : super(key: key);

  @override
  State<Reverse_Export_Calculation> createState() =>
      _Reverse_Export_CalculationState();
}

class _Reverse_Export_CalculationState
    extends State<Reverse_Export_Calculation> {
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    //Export Rate
                    buildRowWidget('Export Rate', inputkapas1, 'Cents/lb',
                        FixedHeight, FixedWidth),

                    // Expenses
                    buildRowWidget('Expenses', inputexpense1, '₹/Bale',
                        FixedHeight, FixedWidth),

                    // Exchange Rate
                    buildRowWidget('Exchange Rate', inputkapasia1, 'USD/INR',
                        FixedHeight, FixedWidth),
                  ],
                ),
              ),
